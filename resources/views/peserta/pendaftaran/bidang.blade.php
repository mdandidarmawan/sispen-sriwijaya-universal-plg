                                ...
                                @foreach ($data['kelas'] as $kelas)
                                    <div class="col-lg-4 col-md-4 margin-bottom-40">
                                        <div class="pricing-box pricing-2 mb-4" data-aos="fade-down" data-aos-duration="1200">
                                            <div class="buy-now">
                                                <a href="javascript:void(0);" class="buy-btn">{{ $kelas->kelas_nama }}</a>
                                            </div>
                                            <div class="pricing-header">
                                                <div class="package-type">
                                                    <img src="/images/logo.png" style="width:200px !important" class="img-responsive" alt="">
                                                </div>
                                                <button type="submit" name="kelas_id" value="{{ $kelas->kelas_id }}" class="button full-width margin-top-20 btn-pilih-kategori">Pilih</button>
                                            </div>
