...
@section('content')
    ...
    <div class="container" style="margin-bottom:80px !important; padding-bottom: 20px;">
        <div class="row">
            <form method="POST" action="{{ route('admin.kelasKategori.update', $kelasKategori->kkategori_id) }}">
                @method('PATCH')
                @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="submit-field">
                                                <h5>Nama Kategori Kelas <span style="color:red; margin-left:5px">*</span></h5>
                                                <input type="text" class="with-border" name="nama_kategori" placeholder="Nama Kategori Kelas" value="{{ old('nama_kategori') ? old('nama_kategori') : $kelasKategori->kkategori_nama }}" autofocus>
                                            </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="submit-field">
                                                <h5>Deskripsi Kategori Kelas <span style="color:red; margin-left:5px"></span></h5>
