...
@section('content')
    ...
    <div id="titlebar" class="gradient">
        <div class="container">
            <div class="row">
                <div class="col-md-12"><h2>Pelatihan / Sertifikasi</h2></div>
            </div>
        </div>
    </div>
    ...
    <div class="container" style="margin-bottom:80px !important; padding-bottom: 20px;">
        <div class="row">
            <form method="POST" action="{{ route('admin.sertifikasi.store') }}">
                @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="submit-field">
                                                ...
                                                <input type="text" class="with-border" name="nama_kelas" placeholder="Nama" value="{{ old('nama_kelas') }}" autofocus>
                                            </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="submit-field">
                                                ...
                                                <input type="number" class="with-border" name="harga_kelas_in" placeholder="Harga In-House" value="{{ old('harga_kelas_in') }}" autofocus>
                                            </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="submit-field">
                                                ...
                                                <input autocomplete="off" type="text" class="with-border" name="tanggal_mulai_registrasi" placeholder="dd-mm-yyyy" value="{{ old('tanggal_mulai_registrasi') }}" pattern="\d{1,2}-\d{1,2}-\d{4}" required>
                                            </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="submit-field">
                                                ...
                                                <input autocomplete="off" type="text" class="with-border" name="tanggal_akhir_registrasi" placeholder="dd-mm-yyyy" value="{{ old('tanggal_akhir_registrasi') }}" pattern="\d{1,2}-\d{1,2}-\d{4}" required>
                                            </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="submit-field">
                                                ...
                                                <input autocomplete="off" type="text" class="with-border" name="tanggal_mulai_kelas" placeholder="dd-mm-yyyy" value="{{ old('tanggal_mulai_kelas') }}" pattern="\d{1,2}-\d{1,2}-\d{4}" required>
                                            </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="submit-field">
                                                ...
                                                <input autocomplete="off" type="text" class="with-border" name="tanggal_akhir_kelas" placeholder="dd-mm-yyyy" value="{{ old('tanggal_akhir_kelas') }}" pattern="\d{1,2}-\d{1,2}-\d{4}" required>
                                            </div>
